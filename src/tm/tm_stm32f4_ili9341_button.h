 ...
 *	
 *	#define LCD_BUTTON_MAX_BUTTONS	10
 *	
 */
#ifndef LCD_BUTTON_H
#define LCD_BUTTON_H
...
#define TM_BUTTON_FLAG_LED				0x0010	// Do not display button label
...
extern LCD_Button_t LCD_Buttons[LCD_BUTTON_MAX_BUTTONS];

/**
 * Add new button to library
 *
 * Parameters:
 * 	- LCD_Button_t *button: pointer to LCD_Button_t structure
 *
 * Returns button id on success (starting from 0), or -1 on failure
 */
extern int8_t LCD_Button_Add(LCD_Button_t* button);
 ...
 */
extern ErrorStatus LCD_Button_Draw(uint8_t id);
 ...
 *
 */
extern void LCD_Button_DrawAll(void);
 ...
 */
extern void LCD_Button_Enable(uint8_t id);
 ...
 * 	- uint8_t id: button id
 */
extern void LCD_Button_Disable(uint8_t id);
 ...
 *
 */
extern void LCD_Button_DeleteAll(void);
 ...
 * 	- uint8_t id: button id
 */
extern void LCD_Button_Delete(uint8_t id);
 ...
 */
extern int8_t LCD_Button_Touch(void);
